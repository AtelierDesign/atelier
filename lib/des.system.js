...
<>
  <div className="sand__box">
    <div className="design__system">
      ...
      <p>This is a Paragraph size 1. A really long paragraph of text, to demonstrate prose text, like for example, the kind you might read in a blog post. The reason were using prose here is because the most common use case for this container size is longform
        text. So were previewing some longform text here so we can make sure the container width provides an optimal line length for this font size.</p>
      <div className="bump"></div>

      <div className="component__label">
        <p>Dark</p>
      </div>
      <p className="p_dark">This is a Paragraph size 1. A really long paragraph of text, to demonstrate prose text, like for example, the kind you might read in a blog post. The reason were using prose here is because the most common use case for this container size is longform
        text. So were previewing some longform text here so we can make sure the container width provides an optimal line length for this font size.</p>
      <div className="bump"></div>
  ...
  <div>
    ...
    <div className="des__container_sm">
      <input type="text" id="rounded-email" className="h-30 rounded-sm border-lime flex-1 appearance-none border-2 w-full py-2 px-5 bg-transparent text-gray-600 placeholder-gray-300 shadow-none text-xl" placeholder="Email address" />
    </div>
