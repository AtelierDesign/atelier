...
{`
  ...
  <div className="des__container_sm">
    ...
    <div className="bump"></div>
      <Button className="block__button" variant="primary" size="lg">ATELIER DESIGN YIELD®</Button>
      <Button className="block__button__secondary" variant="primary" size="lg">ATELIER DESIGN YIELD®</Button>
  </div>
  </>
