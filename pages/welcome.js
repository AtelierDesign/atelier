    ...
    <div className="container mx-auto">
      <div className="flex flex-wrap h-auto -mx-0 mb-0 mt-6 z-20 bg-transparent z-8">
        ...
        <div className="w-full mb-4 md:w-full lg:w-full px-2">
          <div className="relative image__xl rounded-lg bg-gray-100 text-sm text-white flex items-center justify-center shadow-md">
        ...
        <div className="w-full mb-8 md:w-1/2 lg:w-1/2 px-2 mb-3">
          <div className="relative image__sm rounded-lg bg-gray-100 text-sm text-grey-dark flex items-center justify-center shadow-md">
            <Image
